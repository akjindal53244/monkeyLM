...
def prepare(
    ...
    assert Path.exists(checkpoint_dir), f"invalid checkpoint path: {checkpoint_dir}"
    print(f"Checkpoint dir: {checkpoint_dir}")

    with open(checkpoint_dir / "lit_config.json", "r") as file:
        config = json.load(file)

        print("\n===MODEL CONFIG from lit_config.json file===")
    ...
    print(f"saving training data to {destination_path}/train.pt ..")
    ...
    print(f"saving test data to {destination_path}/test.pt ..")
