...
class Tokenizer:
    def __init__(self, checkpoint_dir: Path) -> None:
        ...
        if (vocabulary_path := checkpoint_dir / "tokenizer.model").is_file():
            ...
            print(f"Loading tokenizer from sentence-piece model path: {checkpoint_dir}/tokenizer.model..")
            ...
            print(f"Loading tokenizer from {checkpoint_dir}/tokenizer.json file..")
