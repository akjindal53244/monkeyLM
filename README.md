...
simple and extensible repository for training/finetuning medium-sized LMs for Single GPUs. Inspired from nanoGPT ❤️
...
## acknowledgements
Repo is inspired from [nanoGPT](https://github.com/karpathy/nanoGPT)
